...
public class userManager {
    ...
    public String reg(String name, String sex, String pwd, String pwd2, String tel, String email, String city) throws BaseException {
        ...
        if ("男".equals(sex) || "女".equals(sex)) throw  new BusinessException("性别输入男或女");
        ...
        if (tel.length()!=11) throw new  BusinessException("电话必须为11位");
        ...
        try {
            ...
            pst.setString(1,tel);
            rs=pst.executeQuery();
            if (rs.next()) throw new BusinessException("该电话已被注册");
            rs.close();
            pst.close();
